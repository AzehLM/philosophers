...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/04/16 08:17:59 by gueberso          #+#    #+#             */
/*   Updated: 2025/04/19 11:00:06 by gueberso         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
# define JOIN_ERROR "Error: Failed to join philosopher %d"
# define THREAD_ID_ERROR " thread (error code: %d)\n"
